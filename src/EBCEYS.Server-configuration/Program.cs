...
namespace EBCEYS.Server_configuration
{
    ...
    public class Program
    {
        ...
        /// </summary>
        public static string DBConnectionString { get; } = $"Data source={SupportedEnvironmentVariables.ServiceDatabasePath.Value}";
        /// <summary>
        /// The main.
        /// </summary>
        ...
        private static void ConfigureServices(WebApplicationBuilder builder)
        {
            ...
            {
                return sp.GetService<KeysStorageService>()!;
            });
            builder.Services.AddSingleton<ConfigurationProcessingService>();
            builder.Services.AddHostedService(sp =>
            {
                return sp.GetService<ConfigurationProcessingService>()!;
            });
            ...
            {
                opt.IncludeXmlComments(Assembly.GetEntryAssembly(), true);
            });
