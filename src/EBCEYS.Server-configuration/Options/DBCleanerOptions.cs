...
public class DBCleanerOptions
{
    ...
    {
        ArgumentOutOfRangeException.ThrowIfLessThan(timeToStoreUnexistedContainers, TimeSpan.Zero,
            nameof(timeToStoreUnexistedContainers));
    ...
    /// <summary>
    ///     Initiates a new instance of <see cref="DBCleanerOptions" /> with params from
    ///     <see cref="SupportedEnvironmentVariables" />.
    /// </summary>
    /// <returns>A new instance of <see cref="DBCleanerOptions" />.</returns>
    public static DBCleanerOptions CreateFromEnvironment()
    {
        return new DBCleanerOptions(SupportedEnvironmentVariables.DBCleanerTimeToStore.Value!.Value);
    }
}