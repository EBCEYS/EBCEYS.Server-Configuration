...
public class KeysStorageOptions
{
    ...
    public KeysStorageOptions(string keysDirPath, TimeSpan checkKeyFilesPeriod, bool forgetOldKeys)
    {
        ...
        CheckKeyFilesPeriod = checkKeyFilesPeriod > TimeSpan.Zero
            ? checkKeyFilesPeriod
            : SupportedEnvironmentVariables.KeysStorageKeysFilesCheckPeriod.DefaultValue!.Value;
