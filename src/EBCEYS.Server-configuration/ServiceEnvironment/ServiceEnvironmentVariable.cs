...
public static class SupportedEnvironmentVariables
{
    ...
    /// </summary>
    public static ServiceEnvironmentVariable<string> ServiceDatabasePath { get; } =
        new(serviceDatabasePath, "configuration.db");
    ...
    public static IEnumerable<ServiceEnvironmentInfo> Info
    {
        get
        {
            var infos = DefaultEnvironmentVariables.GetVariablesInfo().ToList();
            infos.AddRange(
                [
    ...
    public static string GetHelp()
    {
        ...
        foreach (var info in Info) sb.AppendLine(info.ToString());
        return sb.ToString();
    }
}